...
#
# Options:
#   -c, --conda_env       Specify the name of the Conda environment to find (default: 'spherical-deepkriging')
#   -o, --output_file     Specify the output file path to save the Conda environment path
#
# Example:
#   Find the path of the default Conda environment 'spherical-deepkriging':
