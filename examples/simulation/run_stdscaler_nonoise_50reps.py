...
REPEAT_TOTAL     = 50
CKPT_PATH        = "results_sphere_stdscaler_nonoise_50reps_checkpoint.csv"
...
for repeat in range(REPEAT_TOTAL):
    ...
    best_orders = {}
    dataframe = simulate_data(NUM_SAMPLE, seed)
...
# ── Final summary ─────────────────────────────────────────────────────────────
print("\n" + "="*80)
print("FINAL SUMMARY — 50 repeats, No Noise, StdScaler + clipnorm=1.0 for sphere")
print("="*80)
df = pd.read_csv(CKPT_PATH)
avg = []
for mn in ALL_MODELS:
